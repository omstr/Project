...
public class GraphPlotter3 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        DisplayGraphFloat(DataHandler.game3SessionSuccessRate);
    ...
    public void DisplayGraphFloat(List<float> valuesList)
    {
        ...
        for (int i = 0; i < valuesList.Count; i++)
        {
            ...
            try
            {
                ...
                if (DataHandler.game3Timestamps.Count > maxTimestampCount)
                {
                    int startIndex = DataHandler.game3Timestamps.Count - maxTimestampCount;
                    textLabelX.text = DataHandler.game3Timestamps[startIndex + i].ToString();
                }
                else
                {
                    textLabelX.text = DataHandler.game3Timestamps[i].ToString();
                }
