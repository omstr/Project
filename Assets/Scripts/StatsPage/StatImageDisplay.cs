...
{ 
    ...
    public void UpdateSuccessRate(float successRate, TextMeshProUGUI averageSuccessRateText, Image background)
    {
        // Set the text value
        averageSuccessRateText.text = successRate.ToString("0.##") + "%";
